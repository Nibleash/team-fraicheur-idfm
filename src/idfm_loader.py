...
class IDFMDataLoader:
    ...
    def load_stops_ref(self) -> gpd.GeoDataFrame:
        ...
        df_bus = df[df["arrtype"] == "bus"][["arrid", "arrname", "arrgeopoint", "zdaid"]]
    ...
    def load_lines(self) -> pd.DataFrame:
        ...
        return df[mask][["id_line", "name_line", "air_conditioning"]]
    ...
    #TODO: Exploit validation dataset to prioritise lines and stops
    ...
    def get_stops_lines(self, stops_gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
        ...
        df_arrets_lignes_bus["route_id"] = df_arrets_lignes_bus["route_id"].str.replace("IDFM:", "", regex=False)
        df_arrets_lignes_bus["stop_id"] = df_arrets_lignes_bus["stop_id"].str.replace("IDFM:", "", regex=False)
        stops_for_line = df_arrets_lignes_bus[["route_id", "stop_id"]]
        
        result = stops_gdf.merge(stops_for_line, left_on="arrid", right_on="stop_id", how="inner")
